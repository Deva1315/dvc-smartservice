...
interface AdminPenjualanTiketServisInfoSectionProps {
...
export default function AdminPenjualanTiketServisInfoSection({
  displayNoTiket,
  tanggal,
  setTanggal,
  clearFieldError,
  errors,
  isSubmitting,
}: AdminPenjualanTiketServisInfoSectionProps) {
  return (
    <Paper
      radius="lg"
      p={{ base: "md", sm: "lg" }}
    ...
    >
      <Stack gap="md">
        <Stack gap={4}>
          ...
          <Text fz="sm" c="#6B7280">
            Nomor tiket dan tanggal masuk perangkat servis.
          </Text>
        </Stack>

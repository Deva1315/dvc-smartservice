...
interface AdminPenjualanTiketServisDeviceSectionProps {
...
export default function AdminPenjualanTiketServisDeviceSection({
  form,
  errors,
  isSubmitting,
  handleChange,
}: AdminPenjualanTiketServisDeviceSectionProps) {
  return (
    <Paper
      radius="lg"
      p={{ base: "md", sm: "lg" }}
    ...
    >
      <Stack gap="md">
        <Stack gap={4}>
          ...
          <Text fz="sm" c="#6B7280">
            Lengkapi informasi perangkat dan keluhan customer.
          </Text>
        </Stack>
        ...
        <Stack gap={6}>
          ...
          <Textarea
            ...
            placeholder="Contoh: laptop tidak menyala, layar berkedip, keyboard tidak berfungsi..."
            minRows={5}
            radius="md"
            disabled={isSubmitting}
